...
class ApiStatus
{
	...
	public const ORDER_ITEM_PRODUCT_REPLACED = 901;
	public const ORDER_ITEM_PRODUCT_DELETED = 902;
	public const ORDER_ITEM_PRODUCT_PRODUCT_INVALID = 903;
	public const ORDER_ITEM_PRODUCT_PROVIDER_INVALID = 904;
	public const ORDER_ITEM_PRODUCT_MANUFACTURER_INVALID = 905;
	public const ORDER_ITEM_PRODUCT_PRODUCT_EMPTY = 906;
	public const ORDER_ITEM_PRODUCT_EXIST = 807;

	public const ORDER_ITEM_SERVICE_REPLACED = 951;
	public const ORDER_ITEM_SERVICE_DELETED = 952;
	public const ORDER_ITEM_SERVICE_SERVICE_INVALID = 954;
	public const ORDER_ITEM_SERVICE_PROVIDER_INVALID = 955;
	public const ORDER_ITEM_SERVICE_SERVICE_EMPTY = 956;
}
